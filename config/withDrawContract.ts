export const withDrawContractAddress =
  '0xd9DA2eF0A74c78278a01f504D4976B6270575340';
export const withDrawAbi = [
  ...
  {
    inputs: [{internalType: 'address', name: 'singer', type: 'address'}],
    name: 'changeSinger',
  ...
  {
    inputs: [
      {internalType: 'address', name: 'singer', type: 'address'},
      {internalType: 'address', name: 'wbnb', type: 'address'},
      {internalType: 'address', name: 'dex', type: 'address'},
      {internalType: 'address', name: 'stor', type: 'address'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
